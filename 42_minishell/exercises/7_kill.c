...
/* kill() fonksiyonu yardımıyla bir child prosesi öldürebiliriz

#include <signal.h>

int kill(pid_t pid, int sig);

ilk parametre sonlandırılacak pid, ikincisi sonlandırmak için
kullanıılacak signal. 7 farklı sinyal var fakat en çok kullanılanı
SIGTERM (soft kill) ve SIGKILL (hard kill).

bu fonksiyon başarı durumunda 0 hatada -1 döndürür. */
