...
char *get_next_line(int fd)
{
	...
	// str, eğer buffer_size satırın uzunlugu + null'dan büyükse kalan metni tutacak
	// stringdir. mesela
	// buse\n
	// keklik\n dedin. buffer_size=7 verirsen
	// buse\n okur (5) ve line'a atar; kalan 2 şeyi (ke) str'ye atar
	static char *str;

	if (fd < 0 || BUFFER_SIZE <= 0)
		return (NULL);

	// bu fonksiyonla her bir complete satırı str'de tutar
	str = ft_buff(fd, str);
